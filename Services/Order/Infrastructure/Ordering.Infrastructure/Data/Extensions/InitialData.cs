namespace Ordering.Infrastructure.Data.Extensions
{
    public class InitialData
    {
        ...
        private static readonly Lazy<IEnumerable<Order>> _ordersWithItems = new Lazy<IEnumerable<Order>>(() =>
        {
            ...
            var order1 = Order.Create(
                OrderId.Of(new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa6")), // Fixed GUID
            ...
            var order2 = Order.Create(
                OrderId.Of(new Guid("3fa85f64-5717-4562-b3fc-2c963f66afa7")), // Fixed GUID
        ...
        public static IEnumerable<Order> OrdersWithItems => _ordersWithItems.Value;
    }
}
